...
export default {
  ...
  methods: {
    ...
    getYear: function (id) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/building/year`, {
          params: {
            building_id: id,
          },
        })
    ...
    getDetails: function (id) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/building/details`, {
          params: {
            building_id: id,
          },
        })
    ...
    updateDetail: function () {
      this.$axios
        .$post(`http://128.199.174.15:5000/api/data/building/details`, null, {
          params: {
    ...
    updateOwner: function () {
      this.$axios
        .$put(`http://128.199.174.15:5000/api/data/building/owner`, {
          params: {
    ...
    getDataYearly: function (id, year) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/yearly/building`, {
          params: {
            building_id: id,
            year: year,
          },
    ...
    updateData: function () {
      this.$axios
        .$post(`http://128.199.174.15:5000/api/data/building/data`, null, {
          params: {
    ...
    getEnergy: function (id) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/building/energy`, {
          params: {
            building_id: id,
          },
        })
    ...
    getEnergyMonth: function (id, year) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/building/energy/month`, {
          params: {
            building_id: id,
            year,
          },
    ...
    getEnergyAll: function (id, category, year) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/building/energy/all`, {
          params: {
            building_id: id,
            category: category,
            year: year,
    ...
    getBei: function (id) {
      this.$axios
        .$get(`http://128.199.174.15:5000/api/data/building/bei`, {
          params: {
            building_id: id,
          },
        })
