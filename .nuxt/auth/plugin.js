...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"http://128.199.174.15:5000/api/auth/login","method":"post","propertyName":"token"},"logout":false,"user":{"url":"http://128.199.174.15:5000/api/auth/me","method":"GET","propertyName":false}},"scheme":"local","token":{"maxAge":10000,"type":"Bearer"},"tokenType":"Bearer","localStorage":false,"_name":"local"}))
